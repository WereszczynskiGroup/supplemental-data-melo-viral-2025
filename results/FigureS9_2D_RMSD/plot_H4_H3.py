...
file1 = 'widom_H4_H3_rms2d.dat'
file2 = 'alpha_H4_H3_rms2d.dat'
...
# Add overall title
fig.suptitle('2D RMSD Heatmaps for Viral Connectors', fontsize=14,fontweight='bold', x=0.51)
...
axs[1].set_ylabel('')
#axs[1].hlines(y=-1000, xmin=0, xmax=2000, colors='r', linestyles='-', lw=2)
...
fig.text(0.04, 0.68, 'H4-H3.2', va='center', rotation='vertical')
fig.text(0.04, 0.36, 'H4-H3.1', va='center', rotation='vertical')



fig.text(0.20, 0.05, 'H4-H3.1', va='center', rotation='horizontal')
fig.text(0.36, 0.05, 'H4-H3.2', va='center', rotation='horizontal')

fig.text(0.57, 0.05, 'H4-H3.1', va='center', rotation='horizontal')
fig.text(0.73, 0.05, 'H4-H3.2', va='center', rotation='horizontal')


plt.savefig('rms2d_H4_H3.pdf')
