...
for i in range(1, 5):
    ...
    u = mda.Universe("virus_widom_align.pdb", "virus_widom.run"+str(i)+".xtc")
    ...
    with open('virus_widom_dimer1.'+'sim'+str(i), 'w') as f:
        f.write("#Frame\t#Angle\n")
    ...
    with open('virus_widom_dimer2.'+'sim'+str(i), 'w') as f:
        f.write("#Frame\t#Angle\n")
        for ts in u.trajectory[::1]:
            vector1 = super_helical(u.atoms, tet_H4_H3, DNA_resid)
