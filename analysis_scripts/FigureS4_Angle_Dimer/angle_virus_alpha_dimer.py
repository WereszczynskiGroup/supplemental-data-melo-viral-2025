...
for i in range(1, 5):
    ...
    u = mda.Universe("virus_alpha_align.pdb", "virus_alpha.run"+str(i)+".xtc")
    tet_H4_H3 = "resid 843 or resid 871 or resid 444 or resid 471"
    ...
    with open('virus_alpha_dimer1.'+'sim'+str(i), 'w') as f:
        f.write("#Frame\t#Angle\n")
    ...
    with open('virus_alpha_dimer2.'+'sim'+str(i), 'w') as f:
        f.write("#Frame\t#Angle\n")
        for ts in u.trajectory[::1]:
            vector1 = super_helical(u.atoms, tet_H4_H3, DNA_resid)
