...
for i in {1..4}; do
  ...
  tmpdir="protein_dna_core_prmtops${i}"
  mkdir -p ${tmpdir}

  # Make receptor trajectory
  cpptraj <<_EOF
parm $prmtop
parmstrip !(:295-377,400-590,598-776,799-989,997-1092)
...
_EOF
  ...
  cpptraj <<_EOF
parm $prmtop
parmstrip !(:1-377,400-590,598-776,799-989,997-1092)
...
strip !(:1-377,400-590,598-776,799-989,997-1092)
