...
base_dir="../mmgbsa/H4_H3_connector_dna"
mkdir -p $base_dir
...
for i in {1..4}; do
  ...
  tmpdir="H4_H3_connector_dna_prmtops${i}"
  mkdir -p ${tmpdir}

  # Make receptor trajectory
  cpptraj <<_EOF
parm $prmtop
parmstrip !(:305-491,503-590,598-680,704-890,902-989,997-1079)
...
_EOF
  ...
  cpptraj <<_EOF
parm $prmtop
parmstrip !(:1-294,305-491,503-590,598-680,704-890,902-989,997-1079)
...
strip !(:1-294,305-491,503-590,598-680,704-890,902-989,997-1079)
