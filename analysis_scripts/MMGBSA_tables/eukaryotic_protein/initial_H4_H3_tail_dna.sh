...
base_dir="../mmgbsa/H4_H3_tail_dna"
mkdir -p $base_dir
...
for i in {1..4}; do
  ...
  tmpdir="H4_H3_tail_dna_prmtops${i}"
  mkdir -p ${tmpdir}

  # Make receptor trajectory
  cpptraj <<_EOF
parm $prmtop
parmstrip !(:295-531,547-629,693-780,782-1018,1034-1116,1180-1267)
...
_EOF
  ...
  cpptraj <<_EOF
parm $prmtop
parmstrip !(:1-294,295-531,547-629,693-780,782-1018,1034-1116,1180-1267)
...
strip !(:1-294,295-531,547-629,693-780,782-1018,1034-1116,1180-1267)
