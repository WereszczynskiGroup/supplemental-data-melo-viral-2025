...
for i in {1..4}; do
  ...
  cpptraj <<_EOF
parm $prmtop
parmstrip !(:332-429,450-531,547-648,685-781,819-916,937-1018,1034-1135,1172-1268)
...
_EOF
  ...
  cpptraj <<_EOF
parm $prmtop
parmstrip !(:1-294,332-429,450-531,547-648,685-781,819-916,937-1018,1034-1135,1172-1268)
...
strip !(:1-294,332-429,450-531,547-648,685-781,819-916,937-1018,1034-1135,1172-1268)
